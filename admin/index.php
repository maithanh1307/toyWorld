                     ...
                     <div class="row column1">
                        <div class="col-md-6 col-lg-3">
                           <div class="full counter_section margin_bottom_30">
                              <div class="couter_icon">
                                 <div> 
                                    <i class="fa fa-user yellow_color fa-beat"></i>
                                 </div>
                              </div>
                              <div class="counter_no">
                                 <div>
                                    <p class="total_no">2500</p>
                                    <p class="head_couter">Consumers</p>
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div class="col-md-6 col-lg-3">
                           <div class="full counter_section margin_bottom_30">
                              <div class="couter_icon">
                                 <div> 
                                    <i class="fa fa-clock-o blue1_color fa-shake"></i>
                                 </div>
                              </div>
                              <div class="counter_no">
                                 <div>
                        ...
                        <div class="col-md-6 col-lg-3">
                           <div class="full counter_section margin_bottom_30">
                              <div class="couter_icon">
                                 <div> 
                                    <i class="fa fa-check fa-beat green_color"></i>
                                 </div>
                              </div>
                              <div class="counter_no">
                                 <div>
                                    <p class="total_no">1,805</p>
                                    <p class="head_couter">Safety</p>
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div class="col-md-6 col-lg-3">
                           <div class="full counter_section margin_bottom_30">
                              <div class="couter_icon">
                                 <div> 
                                    <i class="fa fa-comments-o fa-shake red_color"></i>
                                 </div>
                              </div>
                              <div class="counter_no">
                                 <div>
                              ...
                              <div class="row">
                                    <div class="col-md-12">
                                       <div class="progress_bar">
                                          <!-- Skill Bars -->
                                          <span class="skill" style="width:73%;">Teddy Bear <span class="info_valume">73%</span></span>                  
                                          ...
                                          <span class="skill" style="width:62%;">Lego <span class="info_valume">62%</span></span>   
                                          <div class="progress skill-bar">
                                          ...
                                          <span class="skill" style="width:54%;">Vehicle <span class="info_valume">54%</span></span>
                                          <div class="progress skill-bar">
                                          ...
                                          <span class="skill" style="width:82%;">Collectible <span class="info_valume">82%</span></span>
                                          <div class="progress skill-bar">
                                          ...
                                          <span class="skill" style="width:48%;">Robot <span class="info_valume">48%</span></span>
                                          <div class="progress skill-bar">
                                          ...
                                          <span class="skill" style="width:76%;">Doll <span class="info_valume">76%</span></span>
                                          <div class="progress skill-bar">
                                             <div class="progress-bar progress-bar-animated progress-bar-striped" role="progressbar" aria-valuenow="76" aria-valuemin="0" aria-valuemax="100" style="width: 76%;">
                                             </div>
                                          </div>
                                       </div>
                                    </div>
