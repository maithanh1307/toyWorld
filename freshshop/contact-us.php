<?php
   ...
   if (isset($_POST['submit'])) {
      ...
      $customerMess = $_POST['customerMess'];

      // Prepare the SQL statement using prepared statements
      $sql = "INSERT INTO getintouch (customerName, customerMail, customerSubject, customerMess)
               VALUES (?, ?, ?, ?)";
      
      // Prepare and bind parameters
      $stmt = mysqli_prepare($conn, $sql);
      mysqli_stmt_bind_param($stmt, 'ssss', $customerName, $customerMail, $customerSubject, $customerMess);
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group1">
                                        <input type="text" class="form-control" id="name" name="customerName" placeholder="Your Name" required data-error="Please enter your name">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group1">
                                        <input type="text" placeholder="Your Email" id="email" class="form-control" name="customerMail" required data-error="Please enter your email">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group1">
                                        <input type="text" class="form-control" id="subject" name="customerSubject" placeholder="Subject" required data-error="Please enter your Subject">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group1">
                                        <textarea class="form-control" id="message" name="customerMess" placeholder="Your Message" rows="4" data-error="Write your message" required></textarea>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                    <div class="submit-button1 text-center">
                                        <button class="btn hvr-hover1" name="submit" id="submit" type="submit">Send Message</button>
